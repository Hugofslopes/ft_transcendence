export function initializeOrbsAnimation() {
  const canvas = document.getElementById('orbs-canvas') as HTMLCanvasElement;
  if (!canvas) return;
  ...
  function drawConstellations(context: CanvasRenderingContext2D) {
